...
| 5 | Premium Gift Widget | not-started | Phase 4 | Real gift-triggered widget built on the Phase 4 foundation, all 4 families usable for real gift tiers, replaces nothing existing (additive) | — | Must reuse Phase 4's spec (dimensions/timings/z-index) rather than inventing new values per widget |
...
After Phase 4 lands, continue directly to **Phase 5 — Premium Gift Widget**.
